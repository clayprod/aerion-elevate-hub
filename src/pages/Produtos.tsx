  ...
  const fallbackProducts: Product[] = [
    {
      ...
      description: "Plataforma compacta oferecida em duas configurações dedicadas: 640T (câmera térmica 640×512 + sensor visível 48 MP) ou 6K (sensor 1\" de 20 MP). Garante 40 minutos de voo, distância máxima de voo de 24 km, transmissão até 12 km (FCC) / 6 km (CE) e detecção tridirecional até 30 m para inspeções ágeis e missões de segurança.",
      features: [
        "Configurações 640T (térmica + visível) ou 6K (sensor 1\" 20 MP)",
        "Autonomia de 40 min e resistência a ventos de 10.7 m/s",
        "Distância máxima de voo de 24 km",
    ...
    },
    {
      ...
      description: "Sistema de câmeras triplas com navegação Autonomy Engine e SLAM 3D que dispensa georreferenciamento e garante voo seguro em ambientes complexos. Distância máxima de voo de 24 km. A versão 4N combina visão térmica 640×512 + Starlight, enquanto a 4T traz zoom óptico 2.7-10x com híbrido até 160x.",
      features: [
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        keywords={getKeywordsForRoute('/produtos')}
