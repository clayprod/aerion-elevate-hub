...
const products = [
  {
    ...
    description: "Drone enterprise compacto com cargas úteis intercambiáveis: 640T com câmera térmica 640×512 + sensor visível 48 MP ou 6K com sensor 1\" de 20 MP. Oferece 40 minutos de voo, alcance de transmissão de até 12 km (FCC) e sistema de detecção tridirecional para operações ágeis.",
    keySpecs: [
