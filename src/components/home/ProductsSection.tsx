...
const products = [
  ...
  },
  {
    ...
    description: "Drone industrial IP55 com gimbal DG-L35T quíntuplo (duas térmicas, zoom 35x, wide e laser), autonomia de 40 min, alcance de voo até 30 km e navegação Autonomy Engine com sensores 360° e radar milimétrico.",
    keySpecs: [
      "Gimbal DG-L35T: zoom óptico 35x, térmicas 13/45 mm e laser 2000 m",
      "Alcance de voo até 30 km e transmissão 15 km (FCC)",
      "Navegação Autonomy Engine com sensores visuais 360° + radar 60G/24G",
      "Baterias hot swap LiPo 6S e Smart Controller V3 7.9\" 2000 nits",
    ],
